...
`academic-vi` owns language decisions. The PDF translation component owns PDF extraction, formula placeholders, page layout, and reconstruction. The concrete component name and invocation syntax depend on the host environment.
...
```text
Use the available PDF translation component in handoff mode and academic-vi for translation.
